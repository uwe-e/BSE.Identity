...
namespace BSE.Identity.Blazor.Client.Migrations
{
    ...
    [Migration("20260810060933_SeedAdminAndRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BSE.Identity.Blazor.Client.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3bbd9329-5316-425a-be8c-fa514c50a5b1",
                            ...
                            SecurityStamp = "3bbd9329-5316-425a-be8c-fa514c50a5b1",
                            TwoFactorEnabled = false,
                            UserName = "admin@bsetunes.com"
                        });
                });

            modelBuilder.Entity("BSE.Identity.Blazor.Client.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BSE.Identity.Blazor.Client.Models.RefreshToken", b =>
                {
                    b.HasOne("BSE.Identity.Blazor.Client.Models.ApplicationUser", "User")
                        .WithMany()
